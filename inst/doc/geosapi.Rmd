...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/workspaces/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/namespaces/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/datastores/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/featuretypes/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/layers/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/layergroups/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/coveragestores/
...
>**GeoServer API doc**: https://docs.geoserver.org/main/en/user/rest/api/coverages/
